...
class TableViewController: UITableViewController {
    ...
    var jobs: [Job] = [
        ...
        Job(id: 3, title: "Mobile QA Tester", employer: "Emerson Croft", location: "Bucuresti, Cluj-Napoca", publishDate: "16/04/2020", description: "You will identify flaws in processes and improve or replace them", domain: "IT"),
